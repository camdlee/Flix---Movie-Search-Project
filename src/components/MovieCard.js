...
export default function MovieCard({title, backdrop, genres, releaseDate, language, poster, description, rating}) {
  ...
  return (
    <Card sx={{ height: '100%', display:'flex', maxWidth: 345, margin: '2%', flexDirection: 'column', }}>
      <CardMedia
          component="img"
          height= 'auto'
          ...
          <Button onClick={handleOpen} variant="contained" size="small" color="primary">See More</Button>
              ...
              >
                <Box sx={style}>
                  ...
                  <Button onClick={addMovieToFirebase} variant="contained" size="small" color="primary" sx={{marginTop: '3%'}}>
                    Add to Watch List
                  </Button>
                </Box>
              </Modal>
